...
export const RecordingPanel = ({
  ...
  // Shared with both modes: the STT/AI status line and the recording
  // progress bar mean the same thing whether a recording was started
  // manually or triggered by VAD.
  const workingStatus = (
  ...
  return (
    <div className="rounded-lg border border-border/50 bg-muted/30 overflow-hidden">
      {isVadMode ? (
        /* VAD Mode - recording starts and stops automatically, so this is
           status only: no buttons, no keyboard hints. */
